...
public class BaseController {
	...
	//获取所有的数据list，绑定到request上后直接转发到字符串“addList”表示的去往的页面。
	...
	public String getAddInfoAll(HttpServletRequest request){
		try {			
			...
			return "listAll"; //返回字符串表示去往listAll.jsp页面转发到该页面
	...
	public String update(Add add,HttpServletRequest request){ //add对象的属性的值是根据页面直接的name="tname"自动set进去的
		try {			
